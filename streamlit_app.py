...
tab1, tab2 = st.tabs(["Sources", "Appendix"])

with tab1:

    # Title and headers
    st.markdown("<h1 style='text-align: center;'>Syntax, Semantics, and Society</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: center;'>🌐</h1>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: center;'>Machine Learning Based Analysis of Linguistic Relativity</h3>", unsafe_allow_html=True)

    # Section: Data and Methods
    st.markdown("<h4 style='text-align: center; text-decoration: underline;'>Data and Methods</h4>", unsafe_allow_html=True)
    ...
    # Section: Linguistics
    st.markdown("<h4 style='text-align: center; text-decoration: underline;'>Linguistics</h4>", unsafe_allow_html=True)
...
with tab2:
    ...
    st.markdown("<h1 style='text-align: center;'>Appendix</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: center;'>📖</h1>", unsafe_allow_html=True)
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image("./sentence_similarity.png")
    with col3:
        st.write(' ')
